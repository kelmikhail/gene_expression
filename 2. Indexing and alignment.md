...
cd /fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Rsubread/Sooty_Blotch
...
setwd("/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Rsubread/Sooty_Blotch")

# Build Index
library(Rsubread)
buildindex(basename="P_fructicola_Index",reference="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Reference/Sooty_Blotch/P_fructicola.fasta")
...
# for PD_05d
align(index="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Rsubread/Sooty_Blotch/P_fructicola_Index",readfile1="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Raw_Data/Sooty_Blotch/PD_05d_R1.fastq",readfile2="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Raw_Data/Sooty_Blotch/PD_05d_R2.fastq",input_format="FASTQ",output_format="BAM",output_file="PD_05d.bam",nsubreads=14,maxMismatches=5,nthreads=20,phredOffset=33,unique=TRUE,minFragLength=50,maxFragLength=200,PE_orientation="fr",nTrim5=0,nTrim3=0,readGroupID=NULL,readGroup=NULL,color2base=FALSE,DP_GapOpenPenalty=-1, DP_GapExtPenalty=0,DP_MismatchPenalty=0,DP_MatchScore=2)

# for PD_15d
align(index="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Rsubread/Sooty_Blotch/P_fructicola_Index",readfile1="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Raw_Data/Sooty_Blotch/PD_15d_R1.fastq",readfile2="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Raw_Data/Sooty_Blotch/PD_15d_R2.fastq",input_format="FASTQ",output_format="BAM",output_file="PD_15d.bam",nsubreads=14,maxMismatches=5,nthreads=20,phredOffset=33,unique=TRUE,minFragLength=50,maxFragLength=200,PE_orientation="fr",nTrim5=0,nTrim3=0,readGroupID=NULL,readGroup=NULL,color2base=FALSE,DP_GapOpenPenalty=-1, DP_GapExtPenalty=0,DP_MismatchPenalty=0,DP_MatchScore=2)

# for PEG15d
align(index="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Rsubread/Sooty_Blotch/P_fructicola_Index",readfile1="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Raw_Data/Sooty_Blotch/PEG15d_R1.fastq",readfile2="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Raw_Data/Sooty_Blotch/PEG15d_R2.fastq",input_format="FASTQ",output_format="BAM",output_file="PEG15d.bam",nsubreads=14,maxMismatches=5,nthreads=20,phredOffset=33,unique=TRUE,minFragLength=50,maxFragLength=200,PE_orientation="fr",nTrim5=0,nTrim3=0,readGroupID=NULL,readGroup=NULL,color2base=FALSE,DP_GapOpenPenalty=-1, DP_GapExtPenalty=0,DP_MismatchPenalty=0,DP_MatchScore=2)

# Counting features
fc <- featureCounts(files=c("PD_05d.bam","PD_15d.bam","PEG15d.bam"),annot.ext="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Reference/Sooty_Blotch/P_fructicola.gff3",isGTFAnnotationFile=TRUE,GTF.featureType="gene",GTF.attrType="ID",useMetaFeatures=TRUE,countMultiMappingReads=TRUE,fraction=TRUE,genome="/fs/ess/scratch/PAS2303/Your_OSC_ID/Gene_Expression/Reference/Sooty_Blotch/P_fructicola.fasta",isPairedEnd=TRUE,autosort=TRUE,nthreads=20)
